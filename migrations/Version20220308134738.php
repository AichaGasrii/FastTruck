 ...
 */
final class Version20220308134738 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT \'NULL\', CHANGE initial_price initial_price DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE reclamation CHANGE etat etat INT DEFAULT NULL');
