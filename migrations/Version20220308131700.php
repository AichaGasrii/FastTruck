 ...
 */
final class Version20220308131700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE quantite quantite INT NOT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT NULL, CHANGE initial_price initial_price DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE quantite quantite INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT \'NULL\', CHANGE initial_price initial_price DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE reclamation CHANGE etat etat INT DEFAULT NULL');
