 ...
 */
final class Version20220309190002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT NULL, CHANGE initial_price initial_price DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('ALTER TABLE reclamation DROP id_reclamation, CHANGE etat etat INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE discount discount DOUBLE PRECISION DEFAULT \'NULL\', CHANGE initial_price initial_price DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE reclamation ADD id_reclamation INT NOT NULL, CHANGE etat etat INT DEFAULT NULL');
